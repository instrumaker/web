...
(function() {
  ...
  document.addEventListener('turbolinks:load', function(e) {
    if (!isColdBoot && (e.originalEvent.data.timing.visitStart != null)) {
      if (e.originalEvent.data.timing.requestStart != null) {
        return logPageviewWhenVisible("Turbolinks page load");
      } else {
...
(function() {
  ...
  document.addEventListener('page:load turbolinks:load', function(e) {
    ...
    try {
      if (!isColdBoot) {
        times = {};
        if (e.originalEvent.data.timing != null) {
          if (e.originalEvent.data.timing.requestStart != null) {
            times = {
              time_to_first_byte: e.originalEvent.data.timing.requestEnd - e.originalEvent.data.timing.visitStart,
              frontend_time: e.originalEvent.data.timing.visitEnd - e.originalEvent.data.timing.requestEnd
            };
          } else {
            times = {
              time_to_first_byte: 0,
              frontend_time: e.originalEvent.data.timing.visitEnd - e.originalEvent.data.timing.visitStart
            };
          }
        } else {
...
Beanstalk.site_id = 1244
Beanstalk.beacon.autosend = false
